...
class LGEnvMedium(gym.Env):
    ...
    def init(self):
        ...
        self.observation_space = spaces.Box(low=0.0, high=1.0, shape=(1, self.width, self.height, self.depth),
                                            dtype=np.float32)
    ...
    @staticmethod
    def _observation_from_board(width, height, depth, action_mask, board):
    ...
    def step(self, action):
        ...
        obs = LGEnvMedium._observation_from_board(self.width, self.height, self.depth, self.action_mask, self.board)
    ...
    def reset(self):
        ...
        return LGEnvMedium._observation_from_board(self.width, self.height, self.depth, self.action_mask, self.board)
